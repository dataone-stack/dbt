...
SELECT 
  ''as ma_giao_dich,
   ...
   "Ví ShopeePay" as phuong_thuc_thanh_toan,
    ...
    tong_tien_san_pham - phi_co_dinh - phi_dich_vu - phi_thanh_toan  - phi_hoa_hong_tiep_thi_lien_ket - (phi_van_chuyen_thuc_te - phi_van_chuyen_tro_gia_tu_shopee) as tong_tien_da_thanh_toan,
    tong_tien_san_pham,

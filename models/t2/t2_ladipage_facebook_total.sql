...
WHERE od.marketer IS NOT NULL 
  ...
  AND (
        ...
        (od.brand = 'LYB' AND od.order_sources_name IN ('Ladipage Facebook', 'Webcake','Website','Zalo'))
        -- Các brand khác
        OR (od.brand <> 'LYB' AND od.order_sources_name IN ('Facebook', 'Ladipage Facebook', 'Webcake','Website','Zalo'))
      )

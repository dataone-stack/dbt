...
WHERE od.marketer IS NOT NULl and od.order_sources_name in('Facebook','Ladipage Facebook','Webcake')
group by  DATE(DATE_ADD(od.inserted_at, INTERVAL 7 HOUR)),mar.staff,mar.ma_nhan_vien,mar.ma_quan_ly,od.brand
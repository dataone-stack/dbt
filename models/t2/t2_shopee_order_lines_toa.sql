...
sale_detail AS (
  SELECT 
    ...
    COALESCE(CASE WHEN COALESCE(rd.so_tien_hoan_tra, 0) = 0 THEN ((i.discounted_price) / ta.total_tong_tien_san_pham) * detail.voucher_from_seller ELSE 0 END, 0) AS voucher_from_seller,

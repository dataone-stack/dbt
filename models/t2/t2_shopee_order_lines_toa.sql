...
sale_detail as(
 select 
    ...
    i.discounted_price,
    CASE WHEN DATETIME_ADD(rd.update_time, INTERVAL 7 HOUR) = DATETIME_ADD(vi.create_time, INTERVAL 7 HOUR) then so_tien_hoan_tra else 0 end  as so_tien_hoan_tra,

...
UNION ALL
SELECT brand, ngay_hoan_thanh_thanh_toan as date_create, order_id, 'Shopee' AS channel, "" as status, ma_san_pham as sku_code, ten_san_pham as product_name, tong_tien_da_thanh_toan as total_amount, ngay_dat_hang as date_create_order, 'Shopee' AS channel,

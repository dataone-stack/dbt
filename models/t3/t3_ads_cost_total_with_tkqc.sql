select ads.date_start,tkqc.idtkqc,tkqc.nametkqc,tkqc.ma_nhan_vien,tkqc.staff,tkqc.manager, tkqc.brand,tkqc.channel, sum(ads.spend) as chiPhiAds from {{ ref('t2_ads_cost_total') }} as ads

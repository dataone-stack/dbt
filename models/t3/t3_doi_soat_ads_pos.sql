SELECT
    ...
    a.brand,
    a.channel,
    sum((COALESCE(a.doanhThuAds, 0) + COALESCE(a.doanhThuLadi, 0) + COALESCE(a.doanhThuGMVTiktok, 0))) AS totalAds,
    sum(p.total_price_after_sub_discount) AS totalDoanhThuPos

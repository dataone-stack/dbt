...
shop as (
  select date(ngay_tao_don) as ngay_tao_don,shop_id, sum(tien_khach_hang_thanh_toan) as doanh_thu_san from `dtm.t3_revenue_all_channel` --where shop_id in ('VNLCQUWAWR','1360134442') and date(ngay_tao_don) between'2025-11-09' and '2025-11-10'

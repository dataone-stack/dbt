...
,ads_ladipageFacebook_total_with_tkqc AS (
    SELECT
        ...
        ads.revenue_type,
        -- case 
        --     when ads.campaign_id is null then ads.campaign_id
        --     else 
        ads.idtkqc,
        ads.campaign_id,
        ads.nametkqc,
...
select * from a
--select manager, staff, sum(a.chiPhiAds) from a where date(a.date_start) ="2025-08-17" and idtkqc = "1101865400660761" group by manager, staff

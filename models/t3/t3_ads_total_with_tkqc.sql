...
-- Tổng hợp doanhThuLadi theo ma_nhan_vien trước
ladipage_aggregated AS (
  SELECT
    date_insert AS date_start,
    id_staff AS ma_nhan_vien,
    manager,
    brand,
    channel,
...
ads_ladipageFacebook_total_with_tkqc AS (
  ...
  LEFT JOIN ladipage_aggregated AS ladi

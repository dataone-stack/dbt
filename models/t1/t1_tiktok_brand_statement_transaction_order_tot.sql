...
UNION ALL
SELECT 'Max Eagle' as company, 'BE20(kẹo ngậm)' AS brand, 'be20_viet_nam_store' AS shop, * 
FROM `be20vietnamstore_tiktok_shop_dwh.tiktok_shop_be20_viet_nam_store_statement_transaction_order`
UNION ALL
SELECT 'Max Eagle' as company, 'BE20(kẹo ngậm)' AS brand, 'be20_viet_nam' AS shop, * 
FROM `be20vietnam3_tiktok_shop_dwh.tiktok_shop_be20_viet_nam_statement_transaction_order`
UNION ALL
SELECT 'Max Eagle' as company, 'BE20(kẹo ngậm)' AS brand, 'be20_viet_nam_store_2' AS shop, * 

...
union all
SELECT 'One5' as company, 'UME' AS brand, 'cham_soc_lan_da_trang_min' AS shop, * 
...
-- UNION ALL
-- SELECT 'Max Eagle' as company, 'Cà Phê Mâm Xôi' AS brand, 'ca_phe_mam_xoi_store' AS shop, * 
-- FROM `caphemamxoistore_tiktok_shop_dwh.tiktok_shop_ca_phe_mam_xoi_store_statement_transaction_order`
-- UNION ALL
-- SELECT 'Max Eagle' as company, 'Cà Phê Mâm Xôi' AS brand, 'cafe_mam_xoi_store_hcm' AS shop, * 
...
UNION ALL
SELECT 'Max Eagle' as company, 'UME' AS brand, 'ume_beauty_vietnam_tt' AS shop, * 
...
UNION ALL
SELECT 'Max Eagle' as company, 'UME' AS brand, 'belle_store_vn_tt' AS shop, * 
FROM `bellestorevn_tiktok_shop_dwh.tiktok_shop_belle_store_vn_statement_transaction_order`
UNION ALL
SELECT 'Max Eagle' as company, 'Dr Diva' AS brand, 'dr_diva_viet_nam_store_tt' AS shop, * 
FROM `drdivavietnamstore_tiktok_shop_dwh.tiktok_shop_dr_diva_viet_nam_store_statement_transaction_order`
UNION ALL
SELECT 'Max Eagle' as company, 'Cà Phê Mâm Xôi' AS brand, 'ca_phe_mam_xoi_shop_tt' AS shop, * 

...
union all
select * ,'13' as idtkqc from `bellebeautyvietnam_shopee_ads_dwh.shopee_cpc_ads_daily_performance_belle_beauty_vietnam`
union all
select * ,'19' as idtkqc from `caphegiamcanchinhhangvn_shopee_ads_dwh.shopee_cpc_ads_daily_performance_ca_phe_giam_can_chinh_hang_vn`
union all
select * ,'18' as idtkqc from `caphemamxoichinhhang_shopee_ads_dwh.shopee_cpc_ads_daily_performance_ca_phe_mam_xoi_chinh_hang`
union all
select * ,'11' as idtkqc from `drdivabeautystore_shopee_ads_dwh.shopee_cpc_ads_daily_performance_dr_diva_beauty_store`
union all
...
union all
select * ,'20' as idtkqc from `theumelab_shopee_ads_dwh.shopee_cpc_ads_daily_performance_the_ume_lab`
...
UNION ALL
SELECT order_id, total_amount, create_time, order_status, payment_method, shipping_carrier, ship_by_date, buyer_cancel_reason, days_to_ship, checkout_shipping_carrier, 'Max Eagle' as company, 'VIÊN NGẬM TRẮNG DA BE20' AS brand, 'keo_ngam_trang_da_dau_tam_be20' AS shop
...
UNION ALL
SELECT order_id, total_amount, create_time, order_status, payment_method, shipping_carrier, ship_by_date, buyer_cancel_reason, days_to_ship, checkout_shipping_carrier, 'Max Eagle' as company, 'UME' AS brand, 'the_ume_lab' AS shop

...
SELECT 
    ...
    t1.clicks,
    t1.impressions
FROM team_a_tien_tiktok_ads_dwh.team_a_tien_tiktok_ads t1
LEFT JOIN team_a_tien_tiktok_ads_dwh.team_a_tien_tiktok_ads_ad t2 ON t1.ad_id = t2.ad_id
...
SELECT 
    ...
    t1.clicks,
    t1.impressions
FROM team_maxeagle_tiktok_ads_dwh.team_maxeagle_tiktok_ads t1
LEFT JOIN team_maxeagle_tiktok_ads_dwh.team_maxeagle_tiktok_ads_ad t2 ON t1.ad_id = t2.ad_id

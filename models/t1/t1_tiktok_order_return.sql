...
UNION ALL
SELECT 'Max Eagle' as company, 'BE20' AS brand, 'be20_viet_nam_store' AS shop, * FROM `be20vietnamstore_tiktok_shop_dwh.tiktok_shop_be20_viet_nam_store_return_order`
UNION ALL
